...
public class AdminRevenueStrategy implements RevenueStrategy {
    ...
    public List<RevenuePointDTO> generateRevenue(
        ...
        switch (type){
            ...
            case WEEKLY:
                return transactionRepository.adminWeeklyRevenue(from,to);

            case MONTHLY:
                return transactionRepository.adminMonthlyRevenue(from,to);

            case YEARLY:
                return transactionRepository.adminYearlyRevenue(from,to);
